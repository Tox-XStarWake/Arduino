...
#define TRIGGER D1 // Trigger in NodeMCU at pin GPIO16 (D1).
...
IPAddress ip(10,38,210,203);
IPAddress dns(4,2,2,2);
IPAddress gateway(10,38,210,1);
...
void callback(IRCMessage ircMessage) {
  ...
  if (ircMessage.text.indexOf("REPORT") > -1 && ircMessage.nick == "TOXIC__SALT")
      { 
     sendTwitchMessage("TOX GUN REPORTING FOR DUTY.");  
    }
  ...
  if (ircMessage.text.indexOf("SHOOT") > -1 && ircMessage.nick == "TOXIC__SALT")
      { 
      sendTwitchMessage("Blast Tox in the Face!");  
  ...
  if (ircMessage.text.indexOf("Tox is having Flashbacks") > -1 && ircMessage.nick == "INSTRUCTBOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
  ...
  if (ircMessage.text.indexOf("Tox is having Flashbacks") > -1 && ircMessage.nick == "BORIS___BOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
  ...
  if (ircMessage.text.indexOf("Just Activated the Nuclear Bomb") > -1 && ircMessage.nick == "INSTRUCTBOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
  ...
  if (ircMessage.text.indexOf("Just Activated the Nuclear Bomb") > -1 && ircMessage.nick == "BORIS___BOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
