...
void setup() {
  ...
  ArduinoOTA.setHostname("tox-gun");
...
void callback(IRCMessage ircMessage) {
  ...
  if (ircMessage.text.indexOf("REPORT") > -1 && ircMessage.nick == "TOXIC__SALT")
      { 
     sendTwitchMessage("SECRET THING REPORTING FOR DUTY.");  
    }
  ...
  if (ircMessage.text.indexOf("Toxic Bang") > -1 && ircMessage.nick == "INSTRUCTBOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
  ...
  if (ircMessage.text.indexOf("Toxic Bang") > -1 && ircMessage.nick == "BORIS___BOT")
      { 
      //sendTwitchMessage("Blast Tox in the Face!");  
